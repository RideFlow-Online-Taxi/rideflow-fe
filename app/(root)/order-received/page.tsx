        ...
        >
          ...
          <div className="relative">
            ...
            <div className="z-10 relative bg-white rounded-t-xl p-3 flex flex-col w-full gap-3">
              <div className="flex items-center justify-between p-3">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex flex-col">
                    ...
                    <h2 className="text-[#787272] font-bold text-sm">
                      Toyota A42
                    </h2>
                    <p className="text-[#787272] text-sm font-normal">A8012</p>
                  </div>
                </div>
              ...
              <div className="flex items-center border border-dspGray rounded-2xl p-5">
                <div className="flex items-center gap-3">
