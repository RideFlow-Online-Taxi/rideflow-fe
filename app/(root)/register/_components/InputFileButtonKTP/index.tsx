...
const InputFileButtonKTP = () => {
  ...
  return (
    <div>
      <Button
        variant="secondary"
        className="bg-dspOrange text-white px-4 py-2 rounded-none border-2 border-white hover:bg-[#D87C00] focus:outline-none"
      >
        <label htmlFor="file-input-ktp" className="cursor-pointer">
          {fileName}
        </label>
        <input
          id="file-input-ktp"
...
export default InputFileButtonKTP;